...
INSERT INTO "new_Ink" ("createdAt", "creatorId", "id", "name", "public", "rendered", "slug", "source", "updatedAt") SELECT "createdAt", "creatorId", "id", "name", "public", "rendered", "slug", "source", "updatedAt" FROM "Ink";
DROP TABLE "Ink";
